PYTHONWARNINGS=ignore python ./experiments/lowdynamicfluent-drp/step0_create_baselise_run_jaxplan.py
...
PYTHONWARNINGS=ignore python ./experiments/lowdynamicfluent-drp/step3_create_warm_start_policies_and_run_jaxplan.py
